...
interface StudiesProveQuestionProps {
  onNext: () => void;
}

export default function StudiesProveQuestion({
  onNext,
}: StudiesProveQuestionProps) {
  return (
    <>
      <Image
        src="/images/egg_sandwich.61519179.png"
      ...
      <h4 className="headline4" id="quiz__title--info-question">
        Studies prove: eating right helps lose fat and balance sugar levels
      </h4>
      ...
      <ul className="list-none space-y-8" id="quiz__text--info-question">
        <li className="flex items-center">
          ...
          <div className="ml-4">
            <p className="body-regular font-normal">
              <strong>Eat what you love</strong> - and drop pounds, reduce sugar
              spikes, and feel amazing with MyBody.
            </p>
          </div>
        </li>
      </ul>
      ...
      >
        <p className="body-regular">
          📚 <strong>Washington University study:</strong> Losing just{" "}
          <strong>5%</strong> of your weight can improve insulin sensitivity and
          make it easier to control blood sugar - even if you don&apos;t lose
          more.
        </p>
      </div>
