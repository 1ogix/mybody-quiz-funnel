...
export default function FunnelStepPage({ stepId }: FunnelStepPageProps) {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="w-full pb-10 pt-6 tablet:py-16">
        <div
          className="mx-auto w-full max-w-[calc(37rem+2*1rem)] px-4 tablet:max-w-[calc(37rem+2*2rem)] tablet:px-8"
          data-testid={`quiz__question-${stepQuestionKey}`}
        >
          {currentStep.type !== "info" && (
            <div className="mb-4 flex flex-col-reverse gap-4">
              <p className="body-large" style={{ color: "var(--color-secondary-800)" }}>
